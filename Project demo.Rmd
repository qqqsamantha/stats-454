...
```{r,eval=FALSE}
log_hs_model_updated <- stan_glm(is_canceled~.-lead_time -stays_in_weekend_nights -stays_in_week_nights -previous_bookings_not_canceled -booking_changes -adr -reserved_room_type -meal,
                  data = hotel_sub,
                  family = binomial(link = "logit"), 
                  prior = hs_prior, 
                  chains = 4, iter = 500*2, 
